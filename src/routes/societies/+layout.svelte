...
<div class="grid grid-cols-4 min-h-screen">
    <div class="col-span-1 p-12 border-r border-slate-600 leading-loose">
        <img class="w-1/2 mx-auto rounded-3xl" src={page.data.logo} alt={`${page.data.name} logo`} />

        <p class="text-center font-bold text-xl py-8">{page.data.name}</p>
    ...
    <div class="col-span-3 p-12 bg-slate-800">
        <a href="/">
